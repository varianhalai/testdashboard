...
assets.push({
  name: 'FUSDN3CRV',
  type: 'ftoken',
  underlyingAsset: assetByName('USDN3CRV'),
  decimals: 18,
...
assets.push({
  name: 'FBUSDCRV',
  type: 'ftoken',
  underlyingAsset: assetByName('BUSDCRV'),
  decimals: 18,
...
assets.push({
  name: 'FCCRV',
  type: 'ftoken',
  underlyingAsset: assetByName('CCRV'),
  decimals: 18,
...
const weekSevenPools = [
  ...
  {
    asset: assetByName('fSUSHI-WBTC-TBTC'),
